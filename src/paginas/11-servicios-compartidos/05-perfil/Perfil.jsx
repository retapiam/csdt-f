...
import CambiarContrasenaModal from '../../../components/compartidas/CambiarContrasenaModal';
import TwoFAModal from '../../../components/compartidas/TwoFAModal';
          ...
          <div className="space-y-6">
            ...
            <Card className="p-6">
              ...
              <div className="space-y-3">
                <Button onClick={() => setShowChangePassword(true)} className="w-full bg-orange-500 hover:bg-orange-600 text-white py-2 rounded-lg">
                  Cambiar Contraseña
                </Button>
                <Button onClick={() => setShow2FA(true)} className="w-full bg-purple-500 hover:bg-purple-600 text-white py-2 rounded-lg">
                  Autenticación 2FA
                </Button>
              </div>
            </Card>
